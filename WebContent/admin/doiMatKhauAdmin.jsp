...
<section class="content container-fluid">
      <div class="row">
        <div class="box box-info col-sm-8 col-sm-offset-2">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form class="form-horizontal" action="DoiMatKhauAdminServlet" method="Post">
            <div class="box-body">
            ...
            <div class="box-footer n10_box_footer col-sm-8 col-sm-offset-3" >
              <button type="submit" class="btn btn-info pull-left" name="doimkAdmin" id="doimkAdmin" value="doimkAdmin">Đổi mật khẩu</button>
