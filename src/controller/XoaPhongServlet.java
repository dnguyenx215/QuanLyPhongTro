...
/**
 * Servlet implementation class XoaPhongServlet
 */
@WebServlet("/XoaPhongServlet")
public class XoaPhongServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public XoaPhongServlet() {
		super();
...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		String str = request.getParameter("idPhong");
