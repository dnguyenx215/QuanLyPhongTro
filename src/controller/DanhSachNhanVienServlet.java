...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		ArrayList<NhanVien> dsNVNhanVien = nhanVienBO.layHetNhanVien();
		request.setAttribute("dsNVNhanVien", dsNVNhanVien);
		RequestDispatcher rd = request.getRequestDispatcher("admin/qlNhanVien/danhSachNhanVien.jsp");
